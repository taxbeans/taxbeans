...
public class IR7Form2026Test {

	@Test
	public void test() {
		// MJHL IR7
		IR7Form2026 bean = new IR7Form2026();
		bean.setYearEnded(2026);
		...
		FormProcessor.publishDraft(bean, 2026, "ir7-%1$s.pdf", IR7FieldMapper.instance(),
