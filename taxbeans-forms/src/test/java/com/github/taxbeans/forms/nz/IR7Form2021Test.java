...
public class IR7Form2021Test {

	@Test
	public void test() {
		// MJHL IR7
		IR7Form2021 bean = new IR7Form2021();
		bean.setYearEnded(2021);
		...
		FormProcessor.publishDraft(bean, 2021, "ir7-%1$s.pdf", IR7FieldMapper.instance(), 
