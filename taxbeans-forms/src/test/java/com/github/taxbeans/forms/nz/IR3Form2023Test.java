...
public class IR3Form2023Test {

	public IR3Form2023 setupBean(int currentYear, int previousYear) {
		IR3Form2023 bean = new IR3Form2023();
	...
	public void testWithRentsReceivedFalse() {
		...
		IR3Form2023 bean = setupBean(currentYear, previousYear);
