...
public class IR3Form2019Test {
	
	@Test
	public void test() {
		IR3Form2019 bean = new IR3Form2019();
		...
		bean.setDateStartCurrentYearTaxReturn(LocalDate.of(2018, 9, 15));
		bean.setDateEndCurrentYearTaxReturn(LocalDate.of(2019, 2, 26));
		bean.setDateStartExcludedOverseasIncome(LocalDate.of(2018, 5, 13));
		bean.setDateEndExcludedOverseasIncome(LocalDate.of(2019, 2, 16));
		...
		bean.setRefundOtherTaxAccountReceiverYearEnded31March("2019");
		...
		FormProcessor.publishDraft(bean, 2019, "ir3-%1$s.pdf", IR3FieldMapper.getPropertyToFieldMap(2019), 
