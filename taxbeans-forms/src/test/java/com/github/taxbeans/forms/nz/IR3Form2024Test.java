...
public class IR3Form2024Test {

	public IR3Form2024 setupBean(int currentYear, int previousYear) {
		IR3Form2024 bean = new IR3Form2024();
	...
	public void testWithRentsReceivedFalse() {
		...
		IR3Form2024 bean = setupBean(currentYear, previousYear);
