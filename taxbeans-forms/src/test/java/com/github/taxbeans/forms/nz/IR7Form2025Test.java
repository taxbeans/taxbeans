...
public class IR7Form2025Test {

	@Test
	public void test() {
		// MJHL IR7
		IR7Form2025 bean = new IR7Form2025();
		bean.setYearEnded(2025);
		...
		FormProcessor.publishDraft(bean, 2025, "ir7-%1$s.pdf", IR7FieldMapper.instance(),
