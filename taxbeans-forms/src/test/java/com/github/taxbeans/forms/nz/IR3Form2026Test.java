...
public class IR3Form2026Test {

	public IR3Form2026 setupBean(int currentYear, int previousYear) {
		IR3Form2026 bean = new IR3Form2026();
		...
		// Note: residentialPropertyInterestIncurred is REMOVED from 2026 form
		...
		// Note: residentialPropertyInterestIncurred removed from 2026
	...
	public void testWithRentsReceivedFalse() {
		...
		IR3Form2026 bean = setupBean(currentYear, previousYear);
