...
public class IR4Form2020Test {
	
	@Test
	public void test() {
		IR4Form2020 bean = new IR4Form2020();
		...
		FormProcessor.publishDraft(bean, 2020, "ir4-%1$s.pdf", IR4FieldMapper.getPropertyToFieldMap(2020), 
