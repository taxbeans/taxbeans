...
public class IR3Form2018Test {
	
	@Test
	public void test() {
		IR3Form2018 bean = new IR3Form2018();
		...
		bean.setRefundCopiedPlusOverpayment2018(Money.of(new BigDecimal("3618.67"), "NZD"));;
		bean.setTaxPaymentSEROption2018("S");
		bean.setRefundIsTransferredTo2018(true);
		...
		bean.setRefundOtherTaxAccountReceiverYearEnded31March("2018");
