...
public class IR3Form2013 implements FormDestination {
	...
	final Logger logger = LoggerFactory.getLogger(IR3Form2013.class);
	...
	@SkipIfFalse(IR3Form2013.RENTS_RECEIVED)
	...
	@SkipIfFalse(IR3Form2013.OTHER_INCOME_RECEIVED)
	...
	@SkipIfFalse(IR3Form2013.IS_INCOME_FROM_SELF_EMPLOYMENT_RECEIVED)
