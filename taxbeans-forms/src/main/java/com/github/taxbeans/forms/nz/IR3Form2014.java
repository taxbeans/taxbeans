...
public class IR3Form2014 implements FormDestination {
	...
	final Logger logger = LoggerFactory.getLogger(IR3Form2014.class);
	...
	@SkipIfFalse(IR3Form2014.RENTS_RECEIVED)
	...
	@SkipIfFalse(IR3Form2014.OTHER_INCOME_RECEIVED)
	...
	@SkipIfFalse(IR3Form2014.IS_INCOME_FROM_SELF_EMPLOYMENT_RECEIVED)
