...
public class IR7Form2025 implements FormDestination {
	...
	final static Logger logger = LoggerFactory.getLogger(IR7Form2025.class);
	...
	@UseTrueFalseMappings(fieldName="19aa", falseValue="No", trueValue="Yes")
...
//	}
	...
	public boolean isOtherRentalIncomeRadio() {
		return otherRentalIncomeRadio;
	}

	public void setOtherRentalIncomeRadio(boolean otherRentalIncomeRadio) {
		this.otherRentalIncomeRadio = otherRentalIncomeRadio;
	}

	public boolean isTaxablePropertySalesIncomeRadio() {
		return taxablePropertySalesIncomeRadio;
	}
