...
public class IR4Form2025 implements FormDestination {
	...
	// Template box 32C (printed 31C): MaxLen=11 to match neighbour money combs (was 9 in IRD PDF).
	@RightAlign(11)
	...
	final Logger logger = LoggerFactory.getLogger(IR4Form2025.class);
