...
public class IR3Form2012 implements FormDestination {
	...
	final Logger logger = LoggerFactory.getLogger(IR3Form2012.class);
	...
	@SkipIfFalse(IR3Form2012.RENTS_RECEIVED)
	...
	@SkipIfFalse(IR3Form2012.OTHER_INCOME_RECEIVED)
	...
	@SkipIfFalse(IR3Form2012.IS_INCOME_FROM_SELF_EMPLOYMENT_RECEIVED)
