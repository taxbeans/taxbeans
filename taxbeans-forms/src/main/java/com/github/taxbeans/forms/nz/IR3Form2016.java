...
public class IR3Form2016 implements FormDestination {
	...
	final Logger logger = LoggerFactory.getLogger(IR3Form2016.class);
	...
	@SkipIfFalse(IR3Form2016.RENTS_RECEIVED)
	...
	@SkipIfFalse(IR3Form2016.OTHER_INCOME_RECEIVED)
	...
	@SkipIfFalse(IR3Form2016.IS_INCOME_FROM_SELF_EMPLOYMENT_RECEIVED)
