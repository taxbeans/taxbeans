...
public class IR3Form2015 implements FormDestination {
	...
	final Logger logger = LoggerFactory.getLogger(IR3Form2015.class);
	...
	@SkipIfFalse(IR3Form2015.RENTS_RECEIVED)
	...
	@SkipIfFalse(IR3Form2015.OTHER_INCOME_RECEIVED)
	...
	@SkipIfFalse(IR3Form2015.IS_INCOME_FROM_SELF_EMPLOYMENT_RECEIVED)
