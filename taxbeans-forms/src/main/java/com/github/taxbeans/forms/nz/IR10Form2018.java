...
public class IR10Form2018 {
	...
	private static final String INCOME_FROM_LTC_RECEIVED = "N";

	private static final String EXPENSES_OTHER_RECEIVED = "N";

	private static final String EXCESS_IMPUTATION_CREDITS_BROUGHT_FORWARD_ELIGIBLE = "N";

	private static final String TRUST_OR_ESTATE_INCOME_FROM_NZ_RECEIVED = "N";

	private static final String RENTS_RECEIVED = "N";

	private static final String OTHER_INCOME_RECEIVED = "N";

	private static final String SCHEDULAR_PAYMENTS_RECEIVED = "N";

	private static final String IS_INCOME_FROM_SELF_EMPLOYMENT_RECEIVED = "N";

	private static final String INTEREST_FROM_NZ_RECEIVED = "N";

	private static final String IS_INCOME_OTHER_RECEIVED = "N";
	...
	@SkipIfFalse(IR10Form2018.RENTS_RECEIVED)
	...
	@SkipIfFalse(IR10Form2018.OTHER_INCOME_RECEIVED)
	...
	@SkipIfFalse(IR10Form2018.IS_INCOME_FROM_SELF_EMPLOYMENT_RECEIVED)
...
//			acroForm.flatten();
			...
			pdfTemplate.close();
			logger.info("IR3 Form Completed Successfully: " + ir3DraftForm);
		} catch (Exception e) {
