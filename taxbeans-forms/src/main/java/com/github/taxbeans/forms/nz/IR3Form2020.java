...
public class IR3Form2020 implements FormDestination {
	...
	@SkipIfFalse(IR3Form2020.RENTS_RECEIVED)
	...
	@SkipIfFalse(IR3Form2020.IS_INCOME_FROM_SELF_EMPLOYMENT_RECEIVED)
