...
public class IR3Form2017 implements FormDestination {
	...
	final Logger logger = LoggerFactory.getLogger(IR3Form2017.class);
	...
	@SkipIfFalse(IR3Form2017.RENTS_RECEIVED)
	...
	@SkipIfFalse(IR3Form2017.OTHER_INCOME_RECEIVED)
	...
	@SkipIfFalse(IR3Form2017.IS_INCOME_FROM_SELF_EMPLOYMENT_RECEIVED)
