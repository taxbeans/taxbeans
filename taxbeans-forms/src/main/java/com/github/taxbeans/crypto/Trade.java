...
public class Trade extends AbstractCryptoEvent {
	
	final static Logger logger = LoggerFactory.getLogger(Trade.class);

	public static Trade of(BatchGroup batchGroup, 
